...
public class PTRefreshLayout extends ViewGroup {
    ...
    public PTRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PTRefreshLayout);
        final int colorsId = a.getResourceId(R.styleable.PTRefreshLayout_refreshColors, 0);
        final int colorId = a.getResourceId(R.styleable.PTRefreshLayout_refreshColor, 0);
        a.recycle();
        ...
        if (colorsId > 0) {
            ...
            mColorSchemeColors = new int[]{Color.rgb(0xff, 0xff, 0xff), Color.rgb(0xff, 0xff, 0xff), Color.rgb(0xff, 0xD2, 0xff), Color.rgb(0xff, 0xff, 0xff)};
        }
        ...
        setRefreshing(false);
        mRefreshDrawable = new DefaultRefreshDrawable(getContext(), this);
