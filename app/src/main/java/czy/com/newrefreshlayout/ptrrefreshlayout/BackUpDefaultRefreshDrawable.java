 ...
 */
public class BackUpDefaultRefreshDrawable extends RefreshDrawable {
    ...
    public BackUpDefaultRefreshDrawable(Context context, PTRefreshLayout layout) {
...
//        mPercent = percent;
    ...
    public void offsetTopAndBottom(int offset) {
        mOffset += offset;
        Log.e(TAG, "offsetTopAndBottom: mOffset = " + mOffset);
        invalidateSelf();
    }
